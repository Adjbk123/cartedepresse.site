...
final class Version20241022185131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_audit (id INT UNSIGNED AUTO_INCREMENT NOT NULL, type VARCHAR(10) NOT NULL, object_id VARCHAR(255) NOT NULL, discriminator VARCHAR(255) DEFAULT NULL, transaction_hash VARCHAR(40) DEFAULT NULL, diffs JSON DEFAULT NULL, blame_id VARCHAR(255) DEFAULT NULL, blame_user VARCHAR(255) DEFAULT NULL, blame_user_fqdn VARCHAR(255) DEFAULT NULL, blame_user_firewall VARCHAR(100) DEFAULT NULL, ip VARCHAR(45) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX type_6afceb433fe4ba69560e76951ec61a75_idx (type), INDEX object_id_6afceb433fe4ba69560e76951ec61a75_idx (object_id), INDEX discriminator_6afceb433fe4ba69560e76951ec61a75_idx (discriminator), INDEX transaction_hash_6afceb433fe4ba69560e76951ec61a75_idx (transaction_hash), INDEX blame_id_6afceb433fe4ba69560e76951ec61a75_idx (blame_id), INDEX created_at_6afceb433fe4ba69560e76951ec61a75_idx (created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE demande_audit');
