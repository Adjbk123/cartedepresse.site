...
class ImpressionController extends AbstractController
{
    ...
    public function testCardGeneration(
        ...
        HaacInfoRepository $haacInfoRepository
    ): Response
    {
        ...
        $pdfContent = $this->generatePdfContent($carte, $pdfService, $qrCodeService, $historiqueOrganeProfessionnelRepository, $presidentRepository, $haacInfoRepository);
    ...
    ): string
    {
        ...
        $haacInfo = $haacInfoRepository->findOneBy([]);
    ...
    ): Response
    {
        ...
        if (!$carte->getUrlFile()) {
            $this->generateAndSavePdf($carte, $pdfService, $qrCodeService, $historiqueOrganeProfessionnelRepository, $presidentRepository, $entityManager, $haacInfoRepository);
        }
    ...
    {
        $demande = $carte->getDemande();
        $numDemande = str_replace('/', '-', $carte->getNumCarte());
        $qrCodeDataUri = $qrCodeService->generateQrCodeUrl($numDemande);
